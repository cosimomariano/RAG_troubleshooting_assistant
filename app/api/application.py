...
from app.api.incident_context import build_incident_context
...
def create_app(rag_service: TroubleshootingService) -> FastAPI:
   # creazione dell'applicazione iniettando il servizio che esegue il flusso RAG
    ...
    def troubleshoot(request: TroubleshootingRequest) -> TroubleshootingResponse:
        incident_context = build_incident_context(request)
        rag_response = rag_service.troubleshoot(
